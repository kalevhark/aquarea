...
function update_aquarea_serv_data(url, chart) {
  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      chart.get('last_12hour_outdoor_temp').update({data: data.act_outd_temp});
      ...
      $('#t2na_heat').text(data.status.t2na_heat.toFixed(1));
      $('#t2na_tank').text(data.status.t2na_tank.toFixed(1));

      $('#eile_tot').text((data.status.eile_tot).toFixed(1));
      $('#eile_heat').text(data.status.eile_heat.toFixed(1));
      $('#eile_tank').text(data.status.eile_tank.toFixed(1));

      $('.text-month').css("visibility", "visible");

      $('#kuu_tot').text(data.status.kuu_tot.toFixed(1));
      $('#kuu_heat').text(data.status.kuu_heat.toFixed(1));
      $('#kuu_tank').text(data.status.kuu_tank.toFixed(1));

      $('#kuu_eelmine_tot').text(data.status.kuu_eelmine_tot.toFixed(1));
      $('#kuu_eelmine_heat').text(data.status.kuu_eelmine_heat.toFixed(1));
      $('#kuu_eelmine_tank').text(data.status.kuu_eelmine_tank.toFixed(1));

      $('#kuu_aasta_tagasi_tot').text(data.status.kuu_aasta_tagasi_tot.toFixed(1));
      $('#kuu_aasta_tagasi_heat').text(data.status.kuu_aasta_tagasi_heat.toFixed(1));
      $('#kuu_aasta_tagasi_tank').text(data.status.kuu_aasta_tagasi_tank.toFixed(1));

      $('.text-year').css( "visibility", "visible" );

      $('#jooksva_perioodi_tot').text(data.status.jooksva_perioodi_tot.toFixed(1));
      $('#jooksva_perioodi_heat').text(data.status.jooksva_perioodi_heat.toFixed(1));
      $('#jooksva_perioodi_tank').text(data.status.jooksva_perioodi_tank.toFixed(1));

      $('#eelmise_perioodi_tot').text(data.status.eelmise_perioodi_tot.toFixed(1));
      $('#eelmise_perioodi_heat').text(data.status.eelmise_perioodi_heat.toFixed(1));
      $('#eelmise_perioodi_tank').text(data.status.eelmise_perioodi_tank.toFixed(1));
    },
    error: function (XMLHttpRequest, textstatus, errorThrown) {
	  console.log(XMLHttpRequest, textstatus, errorThrown);
    },
